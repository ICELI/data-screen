      ...
      <div class="pure-g e4b-info">
        ...
        <div class="pure-u-1-2">
          <div class="panel-wrap">
            ...
            <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
            <div class="panel-content panel-chart-wrap" id="barPolarStack2"></div>
          </div>
        </div>
      </div>
      <!-- 聚融通 end -->
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      // 图表
      const barPolarStack = echarts.init(document.getElementById('barPolarStack'));
      const barPolarStack2 = echarts.init(document.getElementById('barPolarStack2'));
      ...
      barPolarStack.setOption(barPolarStackOption);
      barPolarStack2.setOption(barPolarStackOption);

      // 圆环
      const doughnut = echarts.init(document.getElementById('doughnut'));
      const doughnutData = [
        {value: 335, name: '工厂型'},
        {value: 310, name: '贸易型'},
        {value: 234, name: '工贸一体型'},
        {value: 135, name: '其他'},
      ];
      ...
      (function () {
        ...
        // todo 重写 dom ready
        const scrollList = document.querySelectorAll('.panel-list-scroll');
